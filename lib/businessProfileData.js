...
export const INDIA_STATES = [
  ...
  "Delhi (NCT)", "Jammu & Kashmir", "Ladakh", "Puducherry", "Chandigarh", "Andaman & Nicobar",
];
...
export const TARGET_MARKETS = [
  ...
  "Export — Indian SEZ (e.g., GIFT City, SEZs)",
  "Export — South Asia (SAARC)",
  "Export — Middle East & Gulf",
  "Export — Southeast Asia (ASEAN)",
  "Export — Europe",

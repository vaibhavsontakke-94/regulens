...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyBRu5jmfRPfy-uZUhSwmJ1Gj4cSB94e-70",
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "regulens-a71f2.firebaseapp.com",
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "regulens-a71f2",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "regulens-a71f2.firebasestorage.app",
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "219444564495",
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:219444564495:web:28c6a4a43b2ab6d4c5c97a",
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-FXW12ZGJL3",
};

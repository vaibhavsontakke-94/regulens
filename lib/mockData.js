...
export const PROBLEMS = [
  {
    ...
    geographic: {
      areas: ["Kano", "Kaduna", "Lagos"],
      businessConcentration: "High in retail corridors of Kano and Lagos",
      severityByArea: { Kano: "High", Kaduna: "Medium", Lagos: "High" },
    },
    audits: [
  ...
  },
  {
    ...
    geographic: {
      areas: ["Abuja", "Lagos", "Port Harcourt"],
      businessConcentration: "Concentrated in commercial clusters",
      severityByArea: { Abuja: "Critical", Lagos: "High", "Port Harcourt": "High" },
    },
    audits: [
  ...
  },
  {
    ...
    geographic: { areas: ["Lagos", "Abuja"], businessConcentration: "Fintech hub clusters", severityByArea: { Lagos: "High", Abuja: "Medium" } },
    audits: [
  ...
  },
  {
    ...
    location: "Lagos, Onne & Port Harcourt",
    ...
    geographic: { areas: ["Lagos", "Onne", "Port Harcourt"], businessConcentration: "Import terminal corridors", severityByArea: { Lagos: "Critical", Onne: "High", "Port Harcourt": "High" } },
    audits: [
  ...
  },
  {
    ...
    geographic: { areas: ["Abuja"], businessConcentration: "Construction clusters", severityByArea: { Abuja: "Medium" } },
    audits: [
  ...
  },
  {
    ...
    geographic: { areas: ["Ibadan", "Ogun", "Kano"], businessConcentration: "Produce export hubs", severityByArea: { Ibadan: "High", Ogun: "Medium", Kano: "High" } },
    audits: [
  ...
  },
  {
    ...
    geographic: { areas: ["Kaduna", "Plateau"], businessConcentration: "Packaged water producers", severityByArea: { Kaduna: "High", Plateau: "Medium" } },
    audits: [
  ...
  },
  {
    ...
    location: "Lagos & National digital channels",
    ...
    geographic: { areas: ["Lagos"], businessConcentration: "Digital lender platforms", severityByArea: { Lagos: "Medium" } },
    audits: [
  ...
  },
  {
    ...
    geographic: { areas: ["Ogun", "Rivers"], businessConcentration: "Manufacturing belts", severityByArea: { Ogun: "Low", Rivers: "Low" } },
    audits: [
  ...
  },
  {
    ...
    geographic: { areas: ["Lagos", "Abuja"], businessConcentration: "Medical distribution hubs", severityByArea: { Lagos: "High", Abuja: "High" } },
    audits: [
...
export const BUSINESSES = [
  { id: "BSN-001", name: "Zambezi Foods", industry: "Food Manufacturing", location: "Kano", impact: "High", risk: "High", status: "Affected" },
  { id: "BSN-002", name: "Helix Pharma Distributors", industry: "Pharmaceuticals", location: "Lagos", impact: "High", risk: "Medium", status: "Affected" },
  { id: "BSN-003", name: "Nortex Textiles", industry: "Manufacturing", location: "Kaduna", impact: "Medium", risk: "Low", status: "Monitored" },
  { id: "BSN-004", name: "Atlas Energy Retail", industry: "Energy", location: "Port Harcourt", impact: "High", risk: "High", status: "Affected" },
  { id: "BSN-005", name: "ClearWaters Ltd", industry: "Beverages", location: "Abuja", impact: "Medium", risk: "Medium", status: "Monitored" },
  { id: "BSN-006", name: "DigitFinance", industry: "Fintech", location: "Lagos", impact: "High", risk: "Medium", status: "At Risk" },
  { id: "BSN-007", name: "AgriLink Exports", industry: "Agricultural Exports", location: "Ibadan", impact: "High", risk: "High", status: "Affected" },
  { id: "BSN-008", name: "BuildRight Contractors", industry: "Construction", location: "Abuja", impact: "Medium", risk: "Low", status: "Monitored" },
  { id: "BSN-009", name: "MedSupply Africa", industry: "Medical Devices", location: "Lagos", impact: "High", risk: "Medium", status: "Affected" },
  { id: "BSN-010", name: "Payroll Systems Ltd", industry: "Financial Services", location: "Enugu", impact: "Medium", risk: "Medium", status: "At Risk" },
];
...
export const EVIDENCE = [
  ...
  { id: "EVD-002", problemId: "PRB-2026-014", type: "Document", title: "Lagos retail corridor price survey", status: "Verified", date: "2026-09-06", before: "17% variance vs reference band", after: "Survey v2 shows 6% variance" },
  { id: "EVD-003", problemId: "PRB-2026-011", type: "Inspection", title: "Onne port cold-chain inspection", status: "Pending", date: "2026-09-09", before: "Backlog of 12,400 consignments", after: "Digitized queue under test" },
  { id: "EVD-004", problemId: "PRB-2026-007", type: "Document", title: "Kaduna water sampling results", status: "Verified", date: "2026-09-02", before: "2 producers above threshold", after: "All samples within band" },

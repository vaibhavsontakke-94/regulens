  ...
  return (
    <>
      ...
      <div className="mb-6 rounded-lg border border-warning/40 bg-warning-soft/30 px-4 py-3 text-sm text-warning">
        <strong>Demo workspace.</strong> All data, KPIs, scores and maps are illustrative only. No real government or business information is presented.
      </div>
      ...
      <div className="mb-8 grid gap-4 lg:grid-cols-2">
        <SectionCard
          ...
          description="Distribution of problems by illustrative priority category."
        >
          <DonutChart
            segments={[
        ...
        <SectionCard
          ...
          description="Illustrative weights used to compute the priority score. Component weights sum to 100%."
        >
          <SegmentBar
            height="h-3"
            segments={[
          ...
          <p className="mt-3 text-xs leading-relaxed text-ink-faint">
            These illustrative weights are for demonstration purposes and do not represent an official or finalized scoring model.
          </p>
        </SectionCard>
      </div>
      ...
      <SectionCard
        ...
        description={`Showing ${filtered.length} problem${filtered.length !== 1 ? "s" : ""}. All data is illustrative mock content.`}
        action={
...
<td className="whitespace-nowrap min-w-0 px-4 py-3 text-ink-subtle">{p.severity}</td>
      ...
      <p className="mt-8 text-center text-xs text-ink-faint">
        All KPIs, problem intelligence, maps and scores are illustrative demo data only.
      </p>
    </>
  );
}
